...
struct aws_hash *aws_sha256_default_new(struct aws_allocator *allocator) {
    ...
    NTSTATUS status = BCryptCreateHash(s_sha256_alg, &bcrypt_hash->hash_handle, bcrypt_hash->hash_obj, (ULONG)s_sha256_obj_len, NULL, 0, 0);
...
struct aws_hash *aws_md5_default_new(struct aws_allocator *allocator) {
    ...
    bcrypt_hash->hash_obj = hash_obj;
    NTSTATUS status = BCryptCreateHash(s_md5_alg, &bcrypt_hash->hash_handle, bcrypt_hash->hash_obj, (ULONG)s_md5_obj_len, NULL, 0, 0);
