...
static int s_sha256_nist_test_case_1_fn(struct aws_allocator *allocator,
                                        void *ctx) {
  (void)ctx;
  ...
  return s_verify_hash_test_case(allocator, &input, &expected_buf,
                                 aws_sha256_new);
}

AWS_TEST_CASE(sha256_nist_test_case_1, s_sha256_nist_test_case_1_fn)

static int s_sha256_nist_test_case_2_fn(struct aws_allocator *allocator,
                                        void *ctx) {
  (void)ctx;
...
static int s_sha256_nist_test_case_3_fn(struct aws_allocator *allocator,
                                        void *ctx) {
  (void)ctx;
...
static int s_sha256_nist_test_case_4_fn(struct aws_allocator *allocator,
                                        void *ctx) {
  (void)ctx;
...
static int s_sha256_nist_test_case_5_fn(struct aws_allocator *allocator,
                                        void *ctx) {
  (void)ctx;
  ...
  struct aws_byte_cursor expected_buf =
      aws_byte_cursor_from_array(expected, sizeof(expected));
  ASSERT_BIN_ARRAYS_EQUALS(expected_buf.ptr, expected_buf.len,
...
static int
s_sha256_nist_test_case_5_truncated_fn(struct aws_allocator *allocator,
                                       void *ctx) {
  (void)ctx;
  ...
  uint8_t output[AWS_SHA256_LEN] = {0};
  struct aws_byte_buf output_buf =
      aws_byte_buf_from_array(output, expected_buf.len);
  output_buf.len = 0;
...
AWS_TEST_CASE(sha256_nist_test_case_5_truncated,
              s_sha256_nist_test_case_5_truncated_fn)

static int s_sha256_nist_test_case_6_fn(struct aws_allocator *allocator,
                                        void *ctx) {
  (void)ctx;
...
static int s_sha256_test_invalid_buffer_fn(struct aws_allocator *allocator,
                                           void *ctx) {
  (void)ctx;
  ...
  ASSERT_ERROR(AWS_ERROR_SHORT_BUFFER,
               aws_sha256_compute(allocator, &input, &output_buf, 0));
  return AWS_OP_SUCCESS;
}

AWS_TEST_CASE(sha256_test_invalid_buffer, s_sha256_test_invalid_buffer_fn)

static int s_sha256_test_oneshot_fn(struct aws_allocator *allocator,
                                    void *ctx) {
  (void)ctx;
  ...
  ASSERT_BIN_ARRAYS_EQUALS(expected, sizeof(expected), output_buf.buffer,
                           output_buf.len);
