...
static int s_ecdsa_p256_test_import_asn1_pkcs8_no_pub_key_pair_fn(struct aws_allocator *allocator, void *ctx) {
    (void)ctx;

    uint8_t asn1_encoded_key_raw[] = {
        0x30, 0x41, 0x02, 0x01, 0x00, 0x30, 0x13, 0x06, 0x07, 0x2A, 0x86, 0x48, 
        0xCE, 0x3D, 0x02, 0x01, 0x06, 0x08, 0x2A, 0x86, 0x48, 0xCE, 0x3D, 0x03, 
        0x01, 0x07, 0x04, 0x24, 0x30, 0x22, 0x02, 0x01, 0x01, 0x04, 0x20, 0x18, 
        0xCD, 0x6B, 0x61, 0x25, 0xB5, 0x37, 0x61, 0xB8, 0xF4, 0x6A, 0xBA, 0x42, 
        0xAF, 0xA9, 0x70, 0x14, 0x9D, 0x72, 0x40, 0x6D, 0x84, 0x00, 0xA8, 0x40, 
        0x02, 0x13, 0x86, 0x8C, 0xA9, 0x2D, 0x63
    };
...
AWS_TEST_CASE(ecdsa_p256_test_import_asn1_pkcs8_no_pub_key_pair, s_ecdsa_p256_test_import_asn1_pkcs8_no_pub_key_pair_fn)
