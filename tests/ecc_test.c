...
static int s_ecdsa_p256_test_import_asn1_key_pair_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    uint8_t asn1_encoded_key_raw[] = {
        ...
        0x08, 0x9a, 0x37, 0x0d, 0x61, 0x7f, 0x5f, 0xeb, 0x9f, 0x55, 0xf7, 0x54, 0xda,
    };
...
static int s_ecdsa_p384_test_import_asn1_key_pair_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    uint8_t asn1_encoded_key_raw[] = {
        ...
        0x27, 0x54, 0xed, 0x97, 0xe6, 0xbd, 0xe0, 0xaf, 0xff, 0xaa, 0xb9, 0x63, 0xf3, 0x21,
    };
...
static int s_ecdsa_test_import_asn1_key_pair_public_only_fn(struct aws_allocator *allocator, void *ctx) {
    ...
    uint8_t asn1_encoded_full_key_raw[] = {
        ...
        0x94, 0xb3, 0xd4, 0x93, 0x06, 0xde, 0x63, 0x8a, 0xa1, 0x1c, 0x3f, 0xb2, 0x57,
    };
    ...
    uint8_t asn1_encoded_pub_key_raw[] = {
        ...
        0xd4, 0x93, 0x06, 0xde, 0x63, 0x8a, 0xa1, 0x1c, 0x3f, 0xb2, 0x57,
    };
...
static int s_ecdsa_export_sec1_roundtrip(struct aws_allocator *allocator, void *ctx) {
    ...
    aws_byte_buf_init(&encoded_buf, allocator, 256);
    ASSERT_SUCCESS(aws_ecc_key_pair_export(imported_key, AWS_CAL_ECC_KEY_EXPORT_PRIVATE_SEC1, &encoded_buf));

    ASSERT_BIN_ARRAYS_EQUALS(asn1_encoded_key.ptr, asn1_encoded_key.len, encoded_buf.buffer, encoded_buf.len);
...
AWS_TEST_CASE(ecdsa_export_sec1_roundtrip, s_ecdsa_export_sec1_roundtrip);

static int s_ecdsa_export_pkcs8_roundtrip(struct aws_allocator *allocator, void *ctx) {
    (void)ctx;
    aws_cal_library_test_init(allocator);
    ...
    struct aws_byte_buf encoded_buf;
    aws_byte_buf_init(&encoded_buf, allocator, 256);
    ASSERT_SUCCESS(aws_ecc_key_pair_export(imported_key, AWS_CAL_ECC_KEY_EXPORT_PRIVATE_PKCS8, &encoded_buf));
...
AWS_TEST_CASE(ecdsa_export_pkcs8_roundtrip, s_ecdsa_export_pkcs8_roundtrip);

static int s_ecdsa_export_spki_roundtrip(struct aws_allocator *allocator, void *ctx) {
    (void)ctx;
    aws_cal_library_test_init(allocator);
    ...
    struct aws_byte_buf encoded_buf;
    aws_byte_buf_init(&encoded_buf, allocator, 256);
    ASSERT_SUCCESS(aws_ecc_key_pair_export(imported_key, AWS_CAL_ECC_KEY_EXPORT_PUBLIC_SPKI, &encoded_buf));
...
AWS_TEST_CASE(ecdsa_export_spki_roundtrip, s_ecdsa_export_spki_roundtrip);
...
static int s_ecdsa_p256_test_oversized_coordinate_rejected(struct aws_allocator *allocator, void *ctx) {
    ...
    static const uint8_t sig_r_34[] = {
        ...
        0x1E, 0x1F, 0x20, 0x21,
        0x02, 0x20,       /* INTEGER, 32 bytes (s) -- valid size */
    ...
    static const uint8_t sig_s_34[] = {
        ...
        0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D,
        0x1E, 0x1F, 0x20,
        0x02, 0x22,       /* INTEGER, 34 bytes (s) -- one byte over max */
...
AWS_TEST_CASE(ecdsa_p256_test_oversized_coordinate_rejected, s_ecdsa_p256_test_oversized_coordinate_rejected)
