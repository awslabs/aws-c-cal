...
static int s_md5_rfc1321_test_case_1_fn(struct aws_allocator *allocator,
                                        void *ctx) {
  (void)ctx;
...
static int s_md5_rfc1321_test_case_2_fn(struct aws_allocator *allocator,
                                        void *ctx) {
  (void)ctx;
...
static int s_md5_rfc1321_test_case_3_fn(struct aws_allocator *allocator,
                                        void *ctx) {
  (void)ctx;
...
static int s_md5_rfc1321_test_case_4_fn(struct aws_allocator *allocator,
                                        void *ctx) {
  (void)ctx;
...
static int s_md5_rfc1321_test_case_5_fn(struct aws_allocator *allocator,
                                        void *ctx) {
  (void)ctx;
...
static int s_md5_rfc1321_test_case_6_fn(struct aws_allocator *allocator,
                                        void *ctx) {
  (void)ctx;
...
static int s_md5_rfc1321_test_case_7_fn(struct aws_allocator *allocator,
                                        void *ctx) {
  (void)ctx;
...
static int
s_md5_rfc1321_test_case_7_truncated_fn(struct aws_allocator *allocator,
                                       void *ctx) {
  (void)ctx;
...
AWS_TEST_CASE(md5_rfc1321_test_case_7_truncated,
              s_md5_rfc1321_test_case_7_truncated_fn)

static int s_md5_verify_known_collision_fn(struct aws_allocator *allocator,
                                           void *ctx) {
  (void)ctx;
  ...
  uint8_t collision_result[] = {
      0x79, 0x05, 0x40, 0x25, 0x25, 0x5f, 0xb1, 0xa2,
      0x6e, 0x4b, 0xc4, 0x22, 0xae, 0xf5, 0x4e, 0xb4,
  };

  uint8_t output1[AWS_MD5_LEN] = {0};
  struct aws_byte_buf output1_buf =
      aws_byte_buf_from_array(output1, sizeof(output1));
  output1_buf.len = 0;

  struct aws_byte_cursor message_1_buf =
      aws_byte_cursor_from_array(message_1, sizeof(message_1));

  ASSERT_SUCCESS(aws_md5_compute(allocator, &message_1_buf, &output1_buf, 0));
  ASSERT_BIN_ARRAYS_EQUALS(collision_result, sizeof(collision_result), output1,
                           sizeof(output1));

  uint8_t output2[AWS_MD5_LEN] = {0};
  struct aws_byte_buf output2_buf =
      aws_byte_buf_from_array(output2, sizeof(output2));
  output2_buf.len = 0;

  struct aws_byte_cursor message_2_buf =
      aws_byte_cursor_from_array(message_2, sizeof(message_2));

  ASSERT_SUCCESS(aws_md5_compute(allocator, &message_2_buf, &output2_buf, 0));
  ASSERT_BIN_ARRAYS_EQUALS(collision_result, sizeof(collision_result), output2,
                           sizeof(output2));
...
static int s_md5_invalid_buffer_size_fn(struct aws_allocator *allocator,
                                        void *ctx) {
  (void)ctx;
  ...
  ASSERT_ERROR(AWS_ERROR_SHORT_BUFFER,
               aws_md5_compute(allocator, &input, &output_buf, 0));
  return AWS_OP_SUCCESS;
}
