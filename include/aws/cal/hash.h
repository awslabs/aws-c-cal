 ...
 * if use this, we will honor it, regardless of compile options. This may be useful for testing purposes. If you did
 * set AWS_BYO_CRYPTO, and you do not call this function you will segfault.
 */
AWS_CAL_API void aws_set_md5_new_fn(aws_hash_new_fn *fn);

/**
 * Set the implementation of sha256 to use. If you compiled without AWS_BYO_CRYPTO, you do not need to call this.
