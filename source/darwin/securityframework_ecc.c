...
const static uint8_t FAKE_X_ECDSA_P256[] = {
...
const static uint8_t FAKE_Y_ECDSA_P256[] = {
...
const static uint8_t FAKE_X_ECDSA_P384[] = {
...
const static uint8_t FAKE_Y_ECDSA_P384[] = {
...
static struct commoncrypto_ecc_key_pair *s_alloc_pair_and_init_buffers(
    ...
    if (pub_x.ptr == NULL || pub_y.ptr == NULL) {
        /* Use the hard-coded fake public keys */
        switch (curve_name) {
            case AWS_CAL_ECDSA_P256:
                pub_x = aws_byte_cursor_from_array(FAKE_X_ECDSA_P256, sizeof(FAKE_X_ECDSA_P256));
                pub_y = aws_byte_cursor_from_array(FAKE_Y_ECDSA_P256, sizeof(FAKE_Y_ECDSA_P256));
                break;
            case AWS_CAL_ECDSA_P384:
                pub_x = aws_byte_cursor_from_array(FAKE_X_ECDSA_P384, sizeof(FAKE_X_ECDSA_P384));
                pub_y = aws_byte_cursor_from_array(FAKE_Y_ECDSA_P384, sizeof(FAKE_Y_ECDSA_P384));
                break;
