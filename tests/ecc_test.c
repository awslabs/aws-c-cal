...
static int s_ecdsa_p521_test_pub_key_derivation_fn(struct aws_allocator *allocator, void *ctx) {
    (void)ctx;

    uint8_t d[] = {
        0x01, 0x84, 0x25, 0x8e, 0xa6, 0x67, 0xab, 0x99, 0xd0, 0x9d, 0x43, 0x63, 0xb3, 0xf5, 0x13, 0x84, 0xfc,
        0x0a, 0xcd, 0x2f, 0x3b, 0x66, 0x25, 0x8e, 0xf3, 0x12, 0x03, 0xed, 0x30, 0x36, 0x3f, 0xcd, 0xa7, 0x66,
        0x1b, 0x6a, 0x81, 0x7d, 0xaa, 0xf8, 0x31, 0x41, 0x5a, 0x1f, 0x21, 0xcb, 0x1c, 0xda, 0x3a, 0x74, 0xcc,
        0x18, 0x65, 0xf2, 0xef, 0x40, 0xf6, 0x83, 0xc1, 0x41, 0x74, 0xea, 0x72, 0x80, 0x3c, 0xff,
    };

    struct aws_byte_cursor private_key = aws_byte_cursor_from_array(d, sizeof(d));

    uint8_t x[] = {
        0x01, 0x9e, 0xe8, 0x18, 0x04, 0x8f, 0x86, 0xad, 0xa6, 0xdb, 0x86, 0x6b, 0x7e, 0x49, 0xa9, 0xb5, 0x35,
        0x75, 0x0c, 0x36, 0x73, 0xcb, 0x61, 0xbb, 0xfe, 0x55, 0x85, 0xc2, 0xdf, 0x26, 0x38, 0x60, 0xfe, 0x4d,
        0x8a, 0xa8, 0xf7, 0x48, 0x6a, 0xed, 0x5e, 0xa2, 0xa4, 0xd7, 0x33, 0xe3, 0x46, 0xea, 0xef, 0xa8, 0x7a,
        0xc5, 0x15, 0xc7, 0x8b, 0x9a, 0x98, 0x6e, 0xe8, 0x61, 0x58, 0x49, 0x26, 0xce, 0x48, 0x60,
    };

    struct aws_byte_cursor pub_x = aws_byte_cursor_from_array(x, sizeof(x));

    uint8_t y[] = {
        0x01, 0xb6, 0x80, 0x9c, 0x89, 0xc0, 0xaa, 0x7f, 0xb0, 0x57, 0xa3, 0x2a, 0xcb, 0xb9, 0xab, 0x4d, 0x7b,
        0x06, 0xba, 0x39, 0xdb, 0xa8, 0x83, 0x3b, 0x9b, 0x54, 0x42, 0x4a, 0xdd, 0x29, 0x56, 0xe9, 0x5f, 0xe4,
        0x8b, 0x7f, 0xbf, 0x60, 0xc3, 0xdf, 0x51, 0x72, 0xbf, 0x38, 0x6f, 0x25, 0x05, 0xf1, 0xe1, 0xbb, 0x28,
        0x93, 0xda, 0x3b, 0x96, 0xd4, 0xf5, 0xae, 0x78, 0xf2, 0x54, 0x48, 0x81, 0xa2, 0x38, 0xf7,
    };

    struct aws_byte_cursor pub_y = aws_byte_cursor_from_array(y, sizeof(y));

    return s_test_key_derivation(allocator, AWS_CAL_ECDSA_P521, private_key, pub_x, pub_y);
}

AWS_TEST_CASE(ecdsa_p521_test_pub_key_derivation, s_ecdsa_p521_test_pub_key_derivation_fn)
...
static int s_ecdsa_p521_test_known_signing_value_fn(struct aws_allocator *allocator, void *ctx) {
    (void)ctx;
    ...
    return s_test_known_signing_value(allocator, AWS_CAL_ECDSA_P521, private_key, pub_x, pub_y);
}

AWS_TEST_CASE(ecdsa_p521_test_known_signing_value, s_ecdsa_p521_test_known_signing_value_fn)
...
static int s_ecdsa_p521_test_key_gen_fn(struct aws_allocator *allocator, void *ctx) {
    (void)ctx;

    return s_test_key_gen(allocator, AWS_CAL_ECDSA_P521);
}

AWS_TEST_CASE(ecdsa_p521_test_key_gen, s_ecdsa_p521_test_key_gen_fn)
...
static int s_ecdsa_p521_test_key_gen_export_fn(struct aws_allocator *allocator, void *ctx) {
    (void)ctx;

    return s_test_key_gen_export(allocator, AWS_CAL_ECDSA_P521);
}

AWS_TEST_CASE(ecdsa_p521_test_key_gen_export, s_ecdsa_p521_test_key_gen_export_fn)
...
static int s_ecdsa_p521_test_import_asn1_key_pair_fn(struct aws_allocator *allocator, void *ctx) {
    (void)ctx;

    uint8_t asn1_encoded_key_raw[] = {
        ,
    };

    struct aws_byte_cursor asn1_encoded_key =
        aws_byte_cursor_from_array(asn1_encoded_key_raw, sizeof(asn1_encoded_key_raw));

    return s_ecdsa_test_import_asn1_key_pair(allocator, asn1_encoded_key, AWS_CAL_ECDSA_P521);
}

AWS_TEST_CASE(ecdsa_p521_test_import_asn1_key_pair, s_ecdsa_p521_test_import_asn1_key_pair_fn)
